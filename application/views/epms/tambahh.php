...
<a href="<?= base_url(); ?>manager"><img src="<?php echo base_url()?>images/logo-cladtek.png" alt="Logo-Cladtek" style="width: 10%; height: auto"></a>
  ...
  <?php echo form_open_multipart('manager/submit');?>
  <form action="<?php echo site_url('manager/submit')?>" method="post" role="form">
  <!-- PART 1 -->
  <table class="table table-bordered" style="color: black">
    ...
    <thead style="background-color: #f2f2f2">
      <tr>
        ...
        <th>Position <br> (Posisi)*</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>
            <input type="text" class="form-control" rows="1" id="name" name="name" value="<?= $fix_epms['full_name'] ?>" readonly>
        </td>
        <td>
  ...
  <table class="table table-bordered" style="color: black">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Date
              <input type="date" class="form-control" rows="1" id="part_4_date1" name="part_4_date1" disabled >
            </td>
            ...
            <td><b>Direct Leader Name</b> <br> Pimpinan Langsung & Tanda Tangan
              ...
              <input type="file" class="form-control" rows="1" id="part_4_dirleader_sign" name="part_4_dirleader_sign" disabled>
              <br>
              <div class="custom-control custom-checkbox">
            ...
            <td><b>Next Higher Leader Name</b> <br> Pimpinan lebih tinggi & Tanda Tangan
              <input type="text" class="form-control" rows="1" id="manager" name="manager" value="<?= $fix_epms['manager'] ?>" disabled>
              <input type="file" class="form-control" rows="1" id="part_4_nextleader_sign" name="part_4_nextleader_sign" disabled>
              <div class="custom-control custom-checkbox">
