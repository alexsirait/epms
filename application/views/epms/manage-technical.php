...
<div class="card shadow mb-4">
    ...
    <div class="ml-4 mt-2">
    <form id="form1" action="<?php echo base_url('technical/emailmanager') ?>" method="POST"> 
  <button type="button" class="btn btn-info">
                            <i class="fas fa-fw fa-mail-bulk"></i>

                        <a href="<?= base_url(); ?>technical/emailmanager" style="color: white" >Send Email to Manager</a>
    </button>
    </div>
