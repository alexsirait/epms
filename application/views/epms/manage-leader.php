...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Data Tables Performance Management System</h6>
    </div>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php if ($data_epms != null) : ?>
                        ...
                        <a href="<?= base_url(); ?>epms/ubahdl/<?= $row['form_id']; ?>" style="color: black" >Update</a>
                        <!--
                        <div>
            <button type="button" class="btn btn-outline-warning">
          ...
          <td style="white-space:nowrap;" class="text-center"><?php echo $row['dirleader_approve']; ?>
          <!--
          <div>
          <button type="button" id="' . $id  . '"class="btn btn-success btn-lg-split btndl" >
                        </div>
                        -->
        </td>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-/bQdsTh/da6pkI1MST/rWKFNjaCP5gBSY4sEBT38Q/9RBh9AH40zEOg7Hlq2THRZ" crossorigin="anonymous"></script>
	...
	<script>
		$('.btndlw').click(function() {
			var id = $('#empID').val();
			var level_id = '2';
			var type = 'Approved';
			console.log($('#departement').val());
			console.log('<?php echo base_url('epms/approval'); ?>/' + $('#department').val() + '/' + id + '/' + level_id + '/' + type);
			var url = '<?php echo base_url('epms/approval'); ?>/' + $('#department').val() + '/' + id + '/' + level_id + '/' + type;
			$.getJSON({
				url: url,
