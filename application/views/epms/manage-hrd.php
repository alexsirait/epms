...
<div class="card shadow mb-4">
    ...
    <!--
    <form id="form1" action="<?php echo base_url('epms/button_emailmanager') ?>" method="POST"> 
  <button type="button"   class=" m-3 mb-3 ml-3 btn btn-info" onclick="emailmanager()"><i class="fas fa-fw fa-mail-bulk"></i> Send Email to Manager</button>
    -->
...
<script>
  ...
  if (result.value) {
    ...
    success:function(data){
      Swal.fire('Sent!','Notification email has been sent to the Manager','success')
      setTimeout(() => {
    ...
    // },
    error:function(){
      Swal.fire('Error','Email failed to be sent','error');
    }
    });
  }
});
