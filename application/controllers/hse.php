...
class HSE extends CI_Controller
{
	...
	public function hrd_hse()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Health, Safety, & Environment';
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_hse();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-hse', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}
	...
	function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			...
			$data = array(
                ...
                //'email' 	=> 'marcojohnvenoel@gmail.com',
