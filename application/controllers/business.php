...
class Business extends CI_Controller
{
	...
	//per dept
	public function hrd_business()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Business Development';
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_business();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-business', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}
	...
	function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			$fullname = 'Reylina Garcia Tayactac';
			...
			$data = array(
                ...
                //'email' 	=> 'reylina.garcia@cladtek.com',
				'nama' 		=> 'Reylina Garcia Tayactac',
				'department' => 'Business Development',
