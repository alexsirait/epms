...
class Prodauto extends CI_Controller
{
	...
	public function hrd_prodauto()
	{
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_prodauto();

		//per section
		$data['sect_ga'] = $this->dashboard_model->sect_prodauto_ga();
		$data['sect_ecs'] = $this->dashboard_model->sect_ecs();
		$data['sect_ea'] = $this->dashboard_model->sect_ea();
		$data['sect_prodauto'] = $this->dashboard_model->sect_prodauto();
		$data['sect_sd'] = $this->dashboard_model->sect_sd();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('home/hrd_prodauto', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}

	public function sect_ga()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Production Automation ( Section : General Affair )';
		...
		$data['data_epms'] = $this->dashboard_model->prodauto_ga();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-prodauto', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}

	public function sect_ecs()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Production Automation ( Section : Electrical Control System )';
		...
		$data['data_epms'] = $this->dashboard_model->prodauto_ecs();
	...
	public function sect_ea()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Production Automation ( Section : Engineering & Automation )';
		...
		$data['data_epms'] = $this->dashboard_model->prodauto_ea();
	...
	public function sect_prodauto()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Production Automation ( Section : Production Automation )';
		...
		$data['data_epms'] = $this->dashboard_model->prodauto_prodauto();
	...
	public function sect_sd()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Production Automation ( Section : System Development )';
		...
		$data['data_epms'] = $this->dashboard_model->prodauto_sd();
	...
	function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			...
			$data = array(
                ...
                //'email' 	=> 'iswantika.putra@cladtek.com',
				'nama' 		=> 'Iswantika Eka Putra',
				'department' => 'Production Automation',
			...
			redirect('prodauto/hrd_prodauto');
	}
