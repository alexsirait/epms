...
class Projectop extends CI_Controller
{
	...
	public function hrd_projectop()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Project Operations';
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_projectop();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-projectop', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}
    ...
    function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			...
			redirect('projectop/hrd_projectop');
	}
