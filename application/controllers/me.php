...
class ME extends CI_Controller
{
	...
	public function hrd_me()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Maintanance & Engineering';
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_me();

		//per section
		$data['sect_electrical'] = $this->dashboard_model->sect_me_electrical();
		$data['sect_engineering'] = $this->dashboard_model->sect_me_engineering();
		$data['sect_fo'] = $this->dashboard_model->sect_me_fo();
		$data['sect_maintanance'] = $this->dashboard_model->sect_me_maintanance();
		$data['sect_me'] = $this->dashboard_model->sect_me_me();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('home/hrd_me', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}

	public function sect_electrical()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Maintanance & Engineering ( Section : Electrical )';
		...
		$data['data_epms'] = $this->dashboard_model->me_electrical();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-me', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}

	public function sect_engineering()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Maintanance & Engineering ( Section : Engineering )';
		...
		$data['data_epms'] = $this->dashboard_model->me_engineering();
	...
	public function sect_fo()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Maintanance & Engineering ( Section : Facility & Operations )';
		...
		$data['data_epms'] = $this->dashboard_model->me_fo();
	...
	public function sect_maintanance()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Maintanance & Engineering ( Section : Maintanance )';
		...
		$data['data_epms'] = $this->dashboard_model->me_maintanance();
	...
	public function sect_me()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Maintanance & Engineering ( Section : Maintanance & Engineering )';
		...
		$data['data_epms'] = $this->dashboard_model->me_me();
	...
	function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			$fullname = 'Wayne Leslie Williams';
			$department = 'Maintanance & Engineering';
			...
			$data = array(
                ...
                //'email' 	=> 'wayne.williams@cladtek.com',
				'nama' 		=> 'Wayne Leslie Williams',
				'department' => 'Maintanance & Engineering',
