...
class QA extends CI_Controller
{
	...
	public function hrd_qa()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Quality Assurance';
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_qa();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-qa', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}
	...
	function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			...
			$data = array(
                ...
                //'email' 	=> 'roma.metalurgi@gmail.com',
