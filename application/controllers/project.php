...
class Project extends CI_Controller
{
	...
	public function hrd_project()
	{
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_project();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-project', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}
    ...
    function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			$fullname = 'Paul Anthony Montague';
			$department = 'Project';
			...
			$data = array(
                ...
                //'email' 	=> 'paul.montague@cladtek.com',
				'nama' 		=> 'Paul Anthony Montague',
				'department' => 'Project',
