...
class Technical extends CI_Controller
{
	...
	public function hrd_technical()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Technical';
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_technical();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-technical', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}
    ...
    function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			...
			redirect('technical/hrd_technical');
	}
