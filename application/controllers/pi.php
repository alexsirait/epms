...
class PI extends CI_Controller
{
	...
	public function hrd_pi()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Process Improvement';
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_pi();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-pi', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}
	...
	function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			$fullname = 'Dayanandan Jayachandra Babu';
			...
			$data = array(
                ...
                //'email' 	=> 'dayanandan@cladtek.com',
				'nama' 		=> 'Dayanandan Jayachandra Babu',
				'department' => 'Process Improvement',
