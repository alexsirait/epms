...
class QC extends CI_Controller
{
	...
	public function hrd_qc()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Quality Control';
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_qc();

		//per section
		$data['sect_nde'] = $this->dashboard_model->sect_nde();
		$data['sect_qcdoc'] = $this->dashboard_model->sect_qcdoc();
		$data['sect_qc'] = $this->dashboard_model->sect_qc();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('home/hrd_qc', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}

	function emailmanager_qc(){
		$loginlink =  site_url() . 'login' . '"';
			$fullname = 'Abdurohman Bin Rawinda';
	...
	//dept QC per section view page
	public function qc_nde()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Quality Control ( NDE )';
		...
		$data['data_epms'] = $this->dashboard_model->qc_nde();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-qc', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}

	public function qc_qcdoc()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Quality Control ( QC Document Controller )';
		...
		$data['data_epms'] = $this->dashboard_model->qc_qcdoc();
	...
	public function qc_qc()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Quality Control ( Section : Quality Control )';
		...
		$data['data_epms'] = $this->dashboard_model->qc_qc();
