...
class Finance extends CI_Controller
{
	...
	public function hrd_finance()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Finance & Accounting';
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_finance();

		//per section
		$data['sect_fa'] = $this->dashboard_model->sect_fa_fa();
		$data['sect_gf'] = $this->dashboard_model->sect_fa_gf();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('home/hrd_finance', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}

	public function sect_fa()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Finance & Accounting ( Section : Finance & Accounting )';
		...
		$data['data_epms'] = $this->dashboard_model->fa_fa();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-finance', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}

	public function sect_gf()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Finance & Accounting ( Section : Group Finance )';
		...
		$data['data_epms'] = $this->dashboard_model->fa_gf();
	...
	function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			$fullname = 'Mediana Magdalena Siagian';
			$department = 'Finance & Accounting';

			$textContent = <<<HEREDOC
			Dear Maam $fullname, <br>
			...
			$data = array(
                ...
                //'email' 	=> 'mediana.siagian@cladtek.com',
				'nama' 		=> 'Mediana Magdalena Siagian',
				'department' => 'Finance & Accounting',
