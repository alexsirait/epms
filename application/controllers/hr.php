...
class HR extends CI_Controller
{
	...
	public function hrd_hr()
	{
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_hr();

        //per section
		$data['sect_ga'] = $this->dashboard_model->sect_hr_ga();
        $data['sect_ghr'] = $this->dashboard_model->sect_ghr();
        $data['sect_hro'] = $this->dashboard_model->sect_hro();
        $data['sect_hr'] = $this->dashboard_model->sect_hr();
        $data['sect_security'] = $this->dashboard_model->sect_security();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('home/hrd_hr', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}
	...
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Human Resources ( Section : General Affair )';
		...
		$data['data_epms'] = $this->dashboard_model->hr_ga();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-hr', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}

    public function sect_ghr()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Human Resources ( Section : Group Human Resources )';
		...
		$data['data_epms'] = $this->dashboard_model->hr_ghr();
    ...
    public function sect_hro()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Human Resources ( Section : HR Operations )';
		...
		$data['data_epms'] = $this->dashboard_model->hr_hro();
    ...
    public function sect_security()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Human Resources ( Section : Security )';
		...
		$data['data_epms'] = $this->dashboard_model->hr_security();
	...
	function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			...
			$data = array(
                ...
                //'email' 	=> 'sigit.naharudin@cladtek.com',
				'nama' 		=> 'Sigit Naharudin',
				'department' => 'Human Resources',
