...
class SCM extends CI_Controller
{
	...
	public function hrd_scm()
	{
		...
		$data['data_epms'] = $this->dashboard_model->tampilhrd_scm();

		//per section
		$data['sect_consumable'] = $this->dashboard_model->sect_scm_consumable();
		$data['sect_logistics'] = $this->dashboard_model->sect_scm_logistics();
		$data['sect_purchasing'] = $this->dashboard_model->sect_scm_purchasing();
		$data['sect_material'] = $this->dashboard_model->sect_scm_material();
		$data['sect_store'] = $this->dashboard_model->sect_scm_store();
		$data['sect_scm'] = $this->dashboard_model->sect_scm_scm();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('home/hrd_scm', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}

	public function sect_consumable()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Supply Chain Management ( Section : Consumable )';
		...
		$data['data_epms'] = $this->dashboard_model->scm_consumable();
		...
		$this->load->view('templates/dashboard', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('epms/manage-scm', $data);
		$this->load->view('templates/footer');
		$this->load->view('templates/footer_login');
	}

	public function sect_logistics()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Supply Chain Management ( Section : Logistics )';
		...
		$data['data_epms'] = $this->dashboard_model->scm_logistics();
	...
	public function sect_purchasing()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Supply Chain Management ( Section : Purchasing )';
		...
		$data['data_epms'] = $this->dashboard_model->scm_purchasing();
	...
	public function sect_store()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Supply Chain Management ( Section : Store )';
		...
		$data['data_epms'] = $this->dashboard_model->scm_store();
	...
	public function sect_material()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Supply Chain Management ( Section : Material )';
		...
		$data['data_epms'] = $this->dashboard_model->scm_material();
	...
	public function sect_scm()
	{
		$this->load->model('dashboard_model');
		$data['judul'] = 'Data PMS Dept. Supply Chain Management ( Section : Supply Chain Management )';
		...
		$data['data_epms'] = $this->dashboard_model->scm_scm();
	...
	function emailmanager(){
		$loginlink =  site_url() . 'login' . '"';
			...
			$data = array(
                ...
                //'email' 	=> 'irwanpardede11@gmail.com',
				'nama' 		=> 'Irwan Loser Pardede',
				'department' => 'Supply Chain Management',
